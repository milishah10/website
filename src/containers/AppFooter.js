...
export function AppFooter() {
  ...
  return (
    <Container display="flex" alignItems="center" mt={4} pb={4}>
      <Copyright>Mili Shah © {currentYear}</Copyright>
      <Socials>
        {/* <Location>
          {({ location }) => (
            <>
        ...
        <SocialLink title={t.twitter} href="https://twitter.com/mili_shah10">
          <FaTwitter />
        </SocialLink>
        <SocialLink title={t.github} href="https://github.com/milishah10">
          <FaGithub />
        </SocialLink>
        <SocialLink
          title={t.linkedin}
          href="https://www.linkedin.com/in/mili-shah10"
        >
          <FaLinkedin />
        </SocialLink>
        <SocialLink title={t.email} href="mailto:milishah1097@gmail.com">
          <FaEnvelope />
        </SocialLink>
      </Socials>
    </Container>
